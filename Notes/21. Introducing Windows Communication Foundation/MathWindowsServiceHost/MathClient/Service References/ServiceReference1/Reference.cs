...
namespace MathClient.ServiceReference1 {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="www.iamchirag.now.sh", ConfigurationName="ServiceReference1.IBasicMath")]
    public interface IBasicMath {
        
        [System.ServiceModel.OperationContractAttribute(Action="www.iamchirag.now.sh/IBasicMath/Add", ReplyAction="www.iamchirag.now.sh/IBasicMath/AddResponse")]
        int Add(int x, int y);
        
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="www.iamchirag.now.sh/IBasicMath/Add", ReplyAction="www.iamchirag.now.sh/IBasicMath/AddResponse")]
